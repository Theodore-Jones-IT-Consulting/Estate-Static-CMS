...
This isn't quite production ready, but it is very functional and there is a functional demonstration of all of the key features, but a few of the more UI-oriented features and themeing is incomplete. I'd say its about 75% to 90% of the way to being something that I would consider using on a live site, and I will likley get it to that point of being ready for a real site very soon (ie. within the month) 
